...
[Nix](https://github.com/nixos/nix) ⭐ 16,082 | 🐛 3,916 | 🌐 C++ | 📅 2026-02-10 is a powerful package manager for Linux and other Unix systems that makes package management reliable and reproducible.
...
* [Nix Starter Config](https://github.com/Misterio77/nix-starter-configs) ⭐ 3,559 | 🐛 24 | 🌐 Nix | 📅 2025-11-15 - A few simple Nix Flake templates for getting started with NixOS + home-manager.
* [NixOS & Flakes Book](https://github.com/ryan4yin/nixos-and-flakes-book) ⭐ 3,004 | 🐛 5 | 🌐 TypeScript | 📅 2026-01-25 - An unofficial and opinionated NixOS & Flakes book for beginners.
...
* [nix-installer](https://github.com/DeterminateSystems/nix-installer) ⭐ 3,425 | 🐛 406 | 🌐 Rust | 📅 2026-02-08 - Opinionated alternative to the official Nix install scripts.
* [nixos-anywhere](https://github.com/nix-community/nixos-anywhere) ⭐ 2,836 | 🐛 93 | 🌐 Shell | 📅 2026-02-08 - Install NixOS everywhere via SSH.
...
* [nixos-infect](https://github.com/elitak/nixos-infect) ⭐ 1,753 | 🐛 63 | 🌐 Shell | 📅 2026-01-21 - Replace a running non-NixOS Linux host with NixOS.
...
* [NixOps](https://github.com/NixOS/nixops) ⭐ 2,113 | 🐛 328 | 🌐 Python | 📅 2025-12-28 - The official Nix deployment tool, compatible with AWS, Hetzner, and more.
* [Colmena](https://github.com/zhaofengli/colmena) ⭐ 1,992 | 🐛 143 | 🌐 Rust | 📅 2026-02-10 - A simple, stateless NixOS deployment tool modeled after NixOps and morph.
...
* [microvm](https://github.com/microvm-nix/microvm.nix) ⭐ 2,239 | 🐛 56 | 🌐 Nix | 📅 2026-02-05 - NixOS-based MicroVMs.
...
* [devenv](https://github.com/cachix/devenv) ⭐ 6,277 | 🐛 340 | 🌐 Rust | 📅 2026-02-09 - A Nix-based tool for creating developer shell environments quickly and reproducibly.
* [nh](https://github.com/nix-community/nh) ⭐ 2,371 | 🐛 71 | 🌐 Rust | 📅 2026-02-09 - Better output for `nix`, `nixos-rebuild`, `home-manager` and nix-darwin CLI leveraging `dix` and `nix-output-monitor`.
...
* [nix-output-monitor](https://github.com/maralorn/nix-output-monitor) ⭐ 1,380 | 🐛 92 | 🌐 Haskell | 📅 2026-02-06 - A tool to produce useful graphs and statistics when building derivations.
...
* [nix-init](https://github.com/nix-community/nix-init) ⭐ 1,288 | 🐛 25 | 🌐 Rust | 📅 2026-02-09 - Generate Nix packages from URLs with hash prefetching, dependency inference, license detection, and more.
...
* [statix](https://github.com/oppiliappan/statix) ⭐ 817 | 🐛 46 | 🌐 Rust | 📅 2026-02-06 - A linter/fixer to check for and fix antipatterns in Nix code.
* [nix-alien](https://github.com/thiagokokada/nix-alien) ⭐ 762 | 🐛 1 | 🌐 Python | 📅 2026-01-20 - Run unpatched binaries on Nix/NixOS easily.
* [deadnix](https://github.com/astro/deadnix) ⭐ 713 | 🐛 7 | 🌐 Rust | 📅 2025-12-15 - Scan Nix files for dead code.
* [nurl](https://github.com/nix-community/nurl) ⭐ 689 | 🐛 11 | 🌐 Rust | 📅 2026-02-06 - Generate Nix fetcher calls from repository URLs.
...
* [nixos-cli](https://github.com/nix-community/nixos-cli) ⭐ 348 | 🐛 6 | 🌐 Go | 📅 2026-02-10 - Configurable all-in-one CLI for common NixOS tools with an emphasis on improved user experience.
...
* [dix](https://github.com/faukah/dix) ⭐ 224 | 🐛 3 | 🌐 Rust | 📅 2026-02-09 - Diff Nix; a super-fast tool to diff Nix related things.
...
* [Devbox](https://github.com/jetify-com/devbox) ⭐ 11,257 | 🐛 408 | 🌐 Go | 📅 2026-02-06 - Instant, portable, and predictable development environments.
* [flox](https://github.com/flox/flox) ⭐ 3,760 | 🐛 398 | 🌐 Rust | 📅 2026-02-09 - Manage and share development environments, package projects, and publish artifacts anywhere.
* [nix-direnv](https://github.com/nix-community/nix-direnv) ⭐ 2,525 | 🐛 9 | 🌐 Shell | 📅 2026-02-08 - A fast loader and flake-compliant configuration for the direnv environment auto-loader.
...
* [nil](https://github.com/oxalica/nil) ⭐ 1,789 | 🐛 35 | 🌐 Rust | 📅 2025-12-10 - NIx Language server, an incremental analysis assistent for writing in Nix.
* [attic](https://github.com/zhaofengli/attic) ⭐ 1,714 | 🐛 157 | 🌐 Rust | 📅 2026-02-08 - Multi-tenant Nix Binary Cache.
...
* [nixd](https://github.com/nix-community/nixd) ⭐ 1,300 | 🐛 68 | 🌐 C++ | 📅 2026-02-09 - Nix language server, based on Nix libraries.
...
* [flake.parts](https://github.com/hercules-ci/flake-parts) ⭐ 1,195 | 🐛 74 | 🌐 Nix | 📅 2026-02-02 - Minimal Nix modules framework for Flakes: split your flakes into modules and get things done with community modules.
* [Arion](https://github.com/hercules-ci/arion) ⭐ 848 | 🐛 100 | 🌐 Nix | 📅 2026-02-05 - Run `docker-compose` with help from Nix/NixOS.
...
* [compose2nix](https://github.com/aksiksi/compose2nix) ⭐ 774 | 🐛 13 | 🌐 Go | 📅 2026-01-12 - Generate a NixOS config from a Docker Compose project.
...
* [npins](https://github.com/andir/npins) ⭐ 471 | 🐛 31 | 🌐 Rust | 📅 2026-02-06 - A simple tool for handling different types of dependencies in a Nix project. It is inspired by and comparable to Niv.
* [MCP-NixOS](https://github.com/utensils/mcp-nixos) ⭐ 432 | 🐛 6 | 🌐 Python | 📅 2026-02-04 - An MCP server that provides AI assistants with accurate information about NixOS packages, options, Home Manager, and nix-darwin configurations.
...
* [Standard](https://github.com/divnix/std) ⭐ 479 | 🐛 53 | 🌐 Nix | 📅 2025-08-25 - An opinionated Nix Flakes framework to keep Nix code in large projects organized, accompanied by a friendly CLI/TUI optized for DevOps scenarios.
* [nixidy](https://github.com/arnarg/nixidy) ⭐ 281 | 🐛 5 | 🌐 Nix | 📅 2026-01-29 - Kubernetes GitOps with Nix and Argo CD.
...
* [haskell.nix](https://github.com/input-output-hk/haskell.nix) ⭐ 621 | 🐛 171 | 🌐 Nix | 📅 2026-02-10 - Alternative Haskell Infrastructure for Nixpkgs.
...
* [kebab](https://github.com/bwkam/kebab) ⭐ 2 | 🐛 0 | 🌐 Nix | 📅 2026-02-09 - Haxe packages for Nix.
...
* [poetry2nix](https://github.com/nix-community/poetry2nix) ⭐ 937 | 🐛 187 | 🌐 Nix | 📅 2026-02-10 - Build Python packages directly from [Poetry's](https://python-poetry.org/) `poetry.lock`. No conversion step needed.
* [uv2nix](https://github.com/pyproject-nix/uv2nix) ⭐ 671 | 🐛 5 | 🌐 Nix | 📅 2026-02-09 - Convert [`uv` workspaces](https://docs.astral.sh/uv/concepts/projects/workspaces/) into pure Nix derivations.
...
* [rust-overlay](https://github.com/oxalica/rust-overlay) ⭐ 1,390 | 🐛 23 | 🌐 Nix | 📅 2026-02-10 - Pure and reproducible nix overlay of binary distributed Rust toolchains.
* [crane](https://github.com/ipetkov/crane) ⭐ 1,275 | 🐛 35 | 🌐 Nix | 📅 2026-02-06 - A Nix library for building Cargo projects with incremental artifact caching.
* [fenix](https://github.com/nix-community/fenix) ⭐ 981 | 🐛 37 | 🌐 Nix | 📅 2026-02-09 - Rust toolchains and Rust analyzer nightly for nix.
...
* [nix-cargo-integration](https://github.com/90-008/nix-cargo-integration) ⭐ 215 | 🐛 5 | 🌐 Nix | 📅 2026-02-09 - A library that allows easy and effortless integration for Cargo projects.
...
* [zig2nix](https://github.com/Cloudef/zig2nix) ⭐ 156 | 🐛 4 | 🌐 Zig | 📅 2026-02-10 - Flake for packaging, building and running Zig projects.
...
* [Home Manager](https://github.com/nix-community/home-manager) ⭐ 9,341 | 🐛 893 | 🌐 Nix | 📅 2026-02-09 - Manage your user configuration just like NixOS.
* [nix-darwin](https://github.com/nix-darwin/nix-darwin) ⭐ 5,056 | 🐛 410 | 🌐 Nix | 📅 2026-02-04 - Manage macOS configuration just like on NixOS.
* [NixOS hardware](https://github.com/NixOS/nixos-hardware) ⭐ 2,921 | 🐛 245 | 🌐 Nix | 📅 2026-02-09 - NixOS profiles to optimize settings for different hardware.
* [NixOS-WSL](https://github.com/nix-community/NixOS-WSL) ⭐ 2,732 | 🐛 46 | 🌐 Nix | 📅 2026-02-09 - Modules for running NixOS on the Windows Subsystem for Linux.
...
* [Stylix](https://github.com/nix-community/stylix) ⭐ 2,126 | 🐛 243 | 🌐 Nix | 📅 2026-02-08 - System-wide colorscheming and typography for NixOS.
* [impermanence](https://github.com/nix-community/impermanence) ⭐ 1,677 | 🐛 90 | 🌐 Nix | 📅 2026-01-27 - Lets you choose what files and directories you want to keep between reboots.
...
* [musnix](https://github.com/musnix/musnix) ⭐ 851 | 🐛 15 | 🌐 Nix | 📅 2026-02-01 - Do real-time audio work in NixOS.
* [nix-bitcoin](https://github.com/fort-nix/nix-bitcoin) ⭐ 594 | 🐛 52 | 🌐 Nix | 📅 2026-02-09 - Modules and packages for Bitcoin nodes with higher-layer protocols with an emphasis on security.
* [nix-mineral](https://github.com/cynicsketch/nix-mineral) ⭐ 439 | 🐛 30 | 🌐 Nix | 📅 2026-02-03 - Conveniently and reasonably harden NixOS.
* [Self Host Blocks](https://github.com/ibizaman/selfhostblocks) ⭐ 417 | 🐛 85 | 🌐 Nix | 📅 2026-02-09 - Modular server management based on NixOS modules and focused on best practices.
* [base16.nix](https://github.com/SenchoPens/base16.nix) ⭐ 269 | 🐛 3 | 🌐 Nix | 📅 2025-08-21 - Flake way to theme programs in [base16](https://github.com/chriskempson/base16) ⭐ 885 | 🐛 1 | 📅 2023-10-12 colorschemes, mustache template support included.
...
* [NixOS Configuration Editor](https://github.com/snowfallorg/nixos-conf-editor) ⭐ 631 | 🐛 17 | 🌐 Rust | 📅 2024-02-07 - Graphical editor for NixOS configuration. Desktop app in Rust and GTK.
...
* [NUR](https://github.com/nix-community/NUR/) ⭐ 1,765 | 🐛 46 | 🌐 Python | 📅 2026-02-10 - Nix User Repositories. The mother of all overlays, allowing access to user repositories and installing packages via attributes.
* [System Manager](https://github.com/numtide/system-manager) ⭐ 1,379 | 🐛 48 | 🌐 Rust | 📅 2026-02-09 - A non-NixOS Linux system configuration tool built on Nix.
...
* [nixpkgs-wayland](https://github.com/nix-community/nixpkgs-wayland) ⭐ 591 | 🐛 51 | 🌐 Nix | 📅 2026-02-08 - Bleeding-edge Wayland packages.
...
* [neovim-nightly-overlay](https://github.com/nix-community/neovim-nightly-overlay) ⭐ 403 | 🐛 1 | 🌐 Nix | 📅 2026-02-10 - Daily bumped Neovim nightly package.
* [awesome-nix-hpc](https://github.com/freuk/awesome-nix-hpc) ⭐ 95 | 🐛 0 | 📅 2025-04-22 - High Performance Computing package sets.
* [nixpkgs-firefox-darwin](https://github.com/bandithedoge/nixpkgs-firefox-darwin) ⭐ 73 | 🐛 3 | 🌐 Nix | 📅 2026-02-10 - Automatically updated Firefox binary packages for macOS.

## Distributions

* [nixbsd](https://github.com/nixos-bsd/nixbsd) ⭐ 855 | 🐛 16 | 🌐 Nix | 📅 2026-01-14 - A NixOS fork with a FreeBSD kernel.

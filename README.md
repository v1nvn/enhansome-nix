...
[Nix](https://github.com/nixos/nix) ⭐ 16,073 | 🐛 3,915 | 🌐 C++ | 📅 2026-02-08 is a powerful package manager for Linux and other Unix systems that makes package management reliable and reproducible.
...
* [Nix Starter Config](https://github.com/Misterio77/nix-starter-configs) ⭐ 3,558 | 🐛 24 | 🌐 Nix | 📅 2025-11-15 - A few simple Nix Flake templates for getting started with NixOS + home-manager.
* [NixOS & Flakes Book](https://github.com/ryan4yin/nixos-and-flakes-book) ⭐ 3,002 | 🐛 5 | 🌐 TypeScript | 📅 2026-01-25 - An unofficial and opinionated NixOS & Flakes book for beginners.
...
* [nix-installer](https://github.com/DeterminateSystems/nix-installer) ⭐ 3,424 | 🐛 407 | 🌐 Rust | 📅 2026-02-08 - Opinionated alternative to the official Nix install scripts.
* [nixos-anywhere](https://github.com/nix-community/nixos-anywhere) ⭐ 2,832 | 🐛 93 | 🌐 Shell | 📅 2026-02-08 - Install NixOS everywhere via SSH.
...
* [Colmena](https://github.com/zhaofengli/colmena) ⭐ 1,989 | 🐛 143 | 🌐 Rust | 📅 2026-02-03 - A simple, stateless NixOS deployment tool modeled after NixOps and morph.
* [deploy-rs](https://github.com/serokell/deploy-rs) ⭐ 1,972 | 🐛 133 | 🌐 Rust | 📅 2026-02-09 - A simple multi-profile Nix-flake deploy tool.
...
* [morph](https://github.com/DBCDK/morph) ⭐ 1,010 | 🐛 57 | 🌐 Go | 📅 2025-11-24 - A tool for managing existing NixOS hosts.
* [comin](https://github.com/nlewo/comin) ⭐ 813 | 🐛 35 | 🌐 Go | 📅 2026-02-05 - A deployment tool to continuously pull from Git repositories.
...
* [microvm](https://github.com/microvm-nix/microvm.nix) ⭐ 2,235 | 🐛 56 | 🌐 Nix | 📅 2026-02-05 - NixOS-based MicroVMs.
...
* [devenv](https://github.com/cachix/devenv) ⭐ 6,273 | 🐛 341 | 🌐 Rust | 📅 2026-02-08 - A Nix-based tool for creating developer shell environments quickly and reproducibly.
* [nh](https://github.com/nix-community/nh) ⭐ 2,367 | 🐛 71 | 🌐 Rust | 📅 2026-02-07 - Better output for `nix`, `nixos-rebuild`, `home-manager` and nix-darwin CLI leveraging `dix` and `nix-output-monitor`.
* [comma](https://github.com/nix-community/comma) ⭐ 1,507 | 🐛 9 | 🌐 Rust | 📅 2025-12-08 - Quickly run any binary; wraps together `nix run` and `nix-index`.
* [nixfmt](https://github.com/NixOS/nixfmt) ⭐ 1,417 | 🐛 26 | 🌐 Haskell | 📅 2026-01-28 - A formatter for Nix code, intended to easily apply a uniform style.
* [nix-output-monitor](https://github.com/maralorn/nix-output-monitor) ⭐ 1,381 | 🐛 92 | 🌐 Haskell | 📅 2026-02-06 - A tool to produce useful graphs and statistics when building derivations.
* [alejandra](https://github.com/kamadorueda/alejandra) ⭐ 1,292 | 🐛 64 | 🌐 Nix | 📅 2026-01-11 - An opinionated Nix code formatter optimized for speed and consistency.
* [nix-init](https://github.com/nix-community/nix-init) ⭐ 1,284 | 🐛 25 | 🌐 Rust | 📅 2026-02-08 - Generate Nix packages from URLs with hash prefetching, dependency inference, license detection, and more.
...
* [nix-tree](https://github.com/utdemir/nix-tree) ⭐ 972 | 🐛 17 | 🌐 Haskell | 📅 2026-02-01 - Interactively browse the dependency graph of Nix derivations.
* [statix](https://github.com/oppiliappan/statix) ⭐ 816 | 🐛 46 | 🌐 Rust | 📅 2026-02-06 - A linter/fixer to check for and fix antipatterns in Nix code.
* [nix-alien](https://github.com/thiagokokada/nix-alien) ⭐ 762 | 🐛 1 | 🌐 Python | 📅 2026-01-20 - Run unpatched binaries on Nix/NixOS easily.
* [deadnix](https://github.com/astro/deadnix) ⭐ 712 | 🐛 7 | 🌐 Rust | 📅 2025-12-15 - Scan Nix files for dead code.
* [nurl](https://github.com/nix-community/nurl) ⭐ 688 | 🐛 11 | 🌐 Rust | 📅 2026-02-06 - Generate Nix fetcher calls from repository URLs.
...
* [nixos-cli](https://github.com/nix-community/nixos-cli) ⭐ 348 | 🐛 8 | 🌐 Go | 📅 2026-02-07 - Configurable all-in-one CLI for common NixOS tools with an emphasis on improved user experience.
...
* [dix](https://github.com/faukah/dix) ⭐ 224 | 🐛 4 | 🌐 Rust | 📅 2026-02-08 - Diff Nix; a super-fast tool to diff Nix related things.
...
* [Devbox](https://github.com/jetify-com/devbox) ⭐ 11,253 | 🐛 408 | 🌐 Go | 📅 2026-02-06 - Instant, portable, and predictable development environments.
* [flox](https://github.com/flox/flox) ⭐ 3,757 | 🐛 394 | 🌐 Rust | 📅 2026-02-07 - Manage and share development environments, package projects, and publish artifacts anywhere.
* [nix-direnv](https://github.com/nix-community/nix-direnv) ⭐ 2,525 | 🐛 8 | 🌐 Shell | 📅 2026-02-08 - A fast loader and flake-compliant configuration for the direnv environment auto-loader.
...
* [nil](https://github.com/oxalica/nil) ⭐ 1,786 | 🐛 35 | 🌐 Rust | 📅 2025-12-10 - NIx Language server, an incremental analysis assistent for writing in Nix.
* [attic](https://github.com/zhaofengli/attic) ⭐ 1,713 | 🐛 157 | 🌐 Rust | 📅 2026-02-08 - Multi-tenant Nix Binary Cache.
* [flake-utils](https://github.com/numtide/flake-utils) ⭐ 1,552 | 🐛 22 | 🌐 Nix | 📅 2024-11-13 - Pure Nix flake utility functions to help with writing flakes.
...
* [nixd](https://github.com/nix-community/nixd) ⭐ 1,298 | 🐛 68 | 🌐 C++ | 📅 2026-02-09 - Nix language server, based on Nix libraries.
...
* [flake.parts](https://github.com/hercules-ci/flake-parts) ⭐ 1,194 | 🐛 74 | 🌐 Nix | 📅 2026-02-02 - Minimal Nix modules framework for Flakes: split your flakes into modules and get things done with community modules.
* [Arion](https://github.com/hercules-ci/arion) ⭐ 847 | 🐛 100 | 🌐 Nix | 📅 2026-02-05 - Run `docker-compose` with help from Nix/NixOS.
...
* [pre-commit-hooks.nix](https://github.com/cachix/git-hooks.nix) ⭐ 775 | 🐛 86 | 🌐 Nix | 📅 2026-02-06 - Run linters/formatters at commit time and on your CI.
...
* [robotnix](https://github.com/nix-community/robotnix) ⭐ 753 | 🐛 76 | 🌐 Nix | 📅 2026-02-08 - A declarative and reproducible build system for Android (AOSP) images.
...
* [nixpkgs-review](https://github.com/Mic92/nixpkgs-review) ⭐ 569 | 🐛 71 | 🌐 Python | 📅 2026-02-09 - The best tool to verify that a pull-request in Nixpkgs is building properly.
...
* [treefmt-nix](https://github.com/numtide/treefmt-nix) ⭐ 542 | 🐛 54 | 🌐 Nix | 📅 2026-02-04 - A formatter that allows formatting all your project files with a single command, all via a single `.nix` file.
...
* [MCP-NixOS](https://github.com/utensils/mcp-nixos) ⭐ 429 | 🐛 6 | 🌐 Python | 📅 2026-02-04 - An MCP server that provides AI assistants with accurate information about NixOS packages, options, Home Manager, and nix-darwin configurations.
...
* [nixidy](https://github.com/arnarg/nixidy) ⭐ 279 | 🐛 5 | 🌐 Nix | 📅 2026-01-29 - Kubernetes GitOps with Nix and Argo CD.
...
* [clj-nix](https://github.com/jlesquembre/clj-nix) ⭐ 171 | 🐛 27 | 🌐 Clojure | 📅 2026-02-08 - Nix helper functions for Clojure projects.
...
* [haskell.nix](https://github.com/input-output-hk/haskell.nix) ⭐ 621 | 🐛 171 | 🌐 Nix | 📅 2026-02-09 - Alternative Haskell Infrastructure for Nixpkgs.
...
* [kebab](https://github.com/bwkam/kebab) ⭐ 2 | 🐛 0 | 🌐 Nix | 📅 2026-02-08 - Haxe packages for Nix.
...
* [lean4-nix](https://github.com/lenianiva/lean4-nix) ⭐ 87 | 🐛 10 | 🌐 Nix | 📅 2026-02-09 -  Nix flake build for Lean 4, and `lake2nix`.
...
* [poetry2nix](https://github.com/nix-community/poetry2nix) ⭐ 937 | 🐛 187 | 🌐 Nix | 📅 2026-02-09 - Build Python packages directly from [Poetry's](https://python-poetry.org/) `poetry.lock`. No conversion step needed.
* [uv2nix](https://github.com/pyproject-nix/uv2nix) ⭐ 670 | 🐛 5 | 🌐 Nix | 📅 2026-02-09 - Convert [`uv` workspaces](https://docs.astral.sh/uv/concepts/projects/workspaces/) into pure Nix derivations.
...
* [rust-overlay](https://github.com/oxalica/rust-overlay) ⭐ 1,390 | 🐛 23 | 🌐 Nix | 📅 2026-02-09 - Pure and reproducible nix overlay of binary distributed Rust toolchains.
* [crane](https://github.com/ipetkov/crane) ⭐ 1,273 | 🐛 34 | 🌐 Nix | 📅 2026-02-06 - A Nix library for building Cargo projects with incremental artifact caching.
* [fenix](https://github.com/nix-community/fenix) ⭐ 981 | 🐛 37 | 🌐 Nix | 📅 2026-02-08 - Rust toolchains and Rust analyzer nightly for nix.
...
* [nix-cargo-integration](https://github.com/90-008/nix-cargo-integration) ⭐ 215 | 🐛 5 | 🌐 Nix | 📅 2026-02-08 - A library that allows easy and effortless integration for Cargo projects.
...
* [zig2nix](https://github.com/Cloudef/zig2nix) ⭐ 156 | 🐛 4 | 🌐 Zig | 📅 2026-02-09 - Flake for packaging, building and running Zig projects.
...
* [Home Manager](https://github.com/nix-community/home-manager) ⭐ 9,336 | 🐛 892 | 🌐 Nix | 📅 2026-02-08 - Manage your user configuration just like NixOS.
* [nix-darwin](https://github.com/nix-darwin/nix-darwin) ⭐ 5,055 | 🐛 411 | 🌐 Nix | 📅 2026-02-04 - Manage macOS configuration just like on NixOS.
* [NixOS hardware](https://github.com/NixOS/nixos-hardware) ⭐ 2,921 | 🐛 243 | 🌐 Nix | 📅 2026-01-25 - NixOS profiles to optimize settings for different hardware.
* [NixOS-WSL](https://github.com/nix-community/NixOS-WSL) ⭐ 2,730 | 🐛 48 | 🌐 Nix | 📅 2026-02-09 - Modules for running NixOS on the Windows Subsystem for Linux.
* [NixVim](https://github.com/nix-community/nixvim) ⭐ 2,655 | 🐛 180 | 🌐 Nix | 📅 2026-02-09 - A Neovim distribution built with Nix modules and Nixpkgs.
* [Stylix](https://github.com/nix-community/stylix) ⭐ 2,125 | 🐛 243 | 🌐 Nix | 📅 2026-02-08 - System-wide colorscheming and typography for NixOS.
...
* [nix-topology](https://github.com/oddlama/nix-topology) ⭐ 856 | 🐛 13 | 🌐 Nix | 📅 2026-02-01 - Generate infrastructure and network diagrams directly from your NixOS configuration.
* [musnix](https://github.com/musnix/musnix) ⭐ 850 | 🐛 15 | 🌐 Nix | 📅 2026-02-01 - Do real-time audio work in NixOS.
...
* [nix-mineral](https://github.com/cynicsketch/nix-mineral) ⭐ 438 | 🐛 31 | 🌐 Nix | 📅 2026-02-03 - Conveniently and reasonably harden NixOS.
* [Self Host Blocks](https://github.com/ibizaman/selfhostblocks) ⭐ 415 | 🐛 85 | 🌐 Nix | 📅 2026-02-09 - Modular server management based on NixOS modules and focused on best practices.
...
* [NUR](https://github.com/nix-community/NUR/) ⭐ 1,765 | 🐛 46 | 🌐 Python | 📅 2026-02-09 - Nix User Repositories. The mother of all overlays, allowing access to user repositories and installing packages via attributes.
* [System Manager](https://github.com/numtide/system-manager) ⭐ 1,377 | 🐛 48 | 🌐 Rust | 📅 2026-02-06 - A non-NixOS Linux system configuration tool built on Nix.
...
* [zig-overlay](https://github.com/mitchellh/zig-overlay) ⭐ 451 | 🐛 17 | 🌐 Nix | 📅 2026-02-09 - A Nix flake packaging the Zig compiler. The flake mirrors the binaries built officially by Zig and does not build them from source.
* [neovim-nightly-overlay](https://github.com/nix-community/neovim-nightly-overlay) ⭐ 403 | 🐛 1 | 🌐 Nix | 📅 2026-02-09 - Daily bumped Neovim nightly package.
* [awesome-nix-hpc](https://github.com/freuk/awesome-nix-hpc) ⭐ 95 | 🐛 0 | 📅 2025-04-22 - High Performance Computing package sets.
* [nixpkgs-firefox-darwin](https://github.com/bandithedoge/nixpkgs-firefox-darwin) ⭐ 73 | 🐛 3 | 🌐 Nix | 📅 2026-02-09 - Automatically updated Firefox binary packages for macOS.

## Distributions

* [nixbsd](https://github.com/nixos-bsd/nixbsd) ⭐ 854 | 🐛 16 | 🌐 Nix | 📅 2026-01-14 - A NixOS fork with a FreeBSD kernel.

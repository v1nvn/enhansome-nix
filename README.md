...
[Nix](https://github.com/nixos/nix) ⭐ 16,090 | 🐛 3,921 | 🌐 C++ | 📅 2026-02-11 is a powerful package manager for Linux and other Unix systems that makes package management reliable and reproducible.
...
* [NixOS & Flakes Book](https://github.com/ryan4yin/nixos-and-flakes-book) ⭐ 3,004 | 🐛 6 | 🌐 TypeScript | 📅 2026-01-25 - An unofficial and opinionated NixOS & Flakes book for beginners.
...
* [nix-installer](https://github.com/DeterminateSystems/nix-installer) ⭐ 3,427 | 🐛 406 | 🌐 Rust | 📅 2026-02-08 - Opinionated alternative to the official Nix install scripts.
* [nixos-anywhere](https://github.com/nix-community/nixos-anywhere) ⭐ 2,838 | 🐛 93 | 🌐 Shell | 📅 2026-02-08 - Install NixOS everywhere via SSH.
...
* [NixOps](https://github.com/NixOS/nixops) ⭐ 2,114 | 🐛 328 | 🌐 Python | 📅 2025-12-28 - The official Nix deployment tool, compatible with AWS, Hetzner, and more.
* [Colmena](https://github.com/zhaofengli/colmena) ⭐ 1,994 | 🐛 143 | 🌐 Rust | 📅 2026-02-10 - A simple, stateless NixOS deployment tool modeled after NixOps and morph.
* [deploy-rs](https://github.com/serokell/deploy-rs) ⭐ 1,974 | 🐛 133 | 🌐 Rust | 📅 2026-02-09 - A simple multi-profile Nix-flake deploy tool.
...
* [comin](https://github.com/nlewo/comin) ⭐ 815 | 🐛 35 | 🌐 Go | 📅 2026-02-05 - A deployment tool to continuously pull from Git repositories.
...
* [microvm](https://github.com/microvm-nix/microvm.nix) ⭐ 2,242 | 🐛 56 | 🌐 Nix | 📅 2026-02-05 - NixOS-based MicroVMs.
...
* [devenv](https://github.com/cachix/devenv) ⭐ 6,281 | 🐛 342 | 🌐 Rust | 📅 2026-02-10 - A Nix-based tool for creating developer shell environments quickly and reproducibly.
* [nh](https://github.com/nix-community/nh) ⭐ 2,374 | 🐛 72 | 🌐 Rust | 📅 2026-02-10 - Better output for `nix`, `nixos-rebuild`, `home-manager` and nix-darwin CLI leveraging `dix` and `nix-output-monitor`.
...
* [nixfmt](https://github.com/NixOS/nixfmt) ⭐ 1,420 | 🐛 26 | 🌐 Haskell | 📅 2026-01-28 - A formatter for Nix code, intended to easily apply a uniform style.
* [nix-output-monitor](https://github.com/maralorn/nix-output-monitor) ⭐ 1,382 | 🐛 92 | 🌐 Haskell | 📅 2026-02-06 - A tool to produce useful graphs and statistics when building derivations.
...
* [nix-init](https://github.com/nix-community/nix-init) ⭐ 1,290 | 🐛 25 | 🌐 Rust | 📅 2026-02-10 - Generate Nix packages from URLs with hash prefetching, dependency inference, license detection, and more.
...
* [nix-alien](https://github.com/thiagokokada/nix-alien) ⭐ 763 | 🐛 1 | 🌐 Python | 📅 2026-01-20 - Run unpatched binaries on Nix/NixOS easily.
* [deadnix](https://github.com/astro/deadnix) ⭐ 714 | 🐛 7 | 🌐 Rust | 📅 2025-12-15 - Scan Nix files for dead code.
* [nurl](https://github.com/nix-community/nurl) ⭐ 690 | 🐛 11 | 🌐 Rust | 📅 2026-02-10 - Generate Nix fetcher calls from repository URLs.
...
* [manix](https://github.com/mlvzk/manix) ⭐ 421 | 🐛 13 | 🌐 Rust | 📅 2024-01-28 - Find configuration options and function documentation for Nixpkgs, NixOS, and Home Manager.
...
* [Devbox](https://github.com/jetify-com/devbox) ⭐ 11,267 | 🐛 408 | 🌐 Go | 📅 2026-02-06 - Instant, portable, and predictable development environments.
* [flox](https://github.com/flox/flox) ⭐ 3,764 | 🐛 392 | 🌐 Rust | 📅 2026-02-11 - Manage and share development environments, package projects, and publish artifacts anywhere.
* [nix-direnv](https://github.com/nix-community/nix-direnv) ⭐ 2,527 | 🐛 9 | 🌐 Shell | 📅 2026-02-08 - A fast loader and flake-compliant configuration for the direnv environment auto-loader.
...
* [attic](https://github.com/zhaofengli/attic) ⭐ 1,717 | 🐛 159 | 🌐 Rust | 📅 2026-02-08 - Multi-tenant Nix Binary Cache.
...
* [compose2nix](https://github.com/aksiksi/compose2nix) ⭐ 775 | 🐛 13 | 🌐 Go | 📅 2026-01-12 - Generate a NixOS config from a Docker Compose project.
...
* [nix-update](https://github.com/Mic92/nix-update) ⭐ 715 | 🐛 49 | 🌐 Python | 📅 2026-02-08 - Update versions/source hashes of nix packages.
* [rnix-lsp](https://github.com/nix-community/rnix-lsp) ⚠️ Archived - A syntax-checking language server for Nix.
* [services-flake](https://github.com/juspay/services-flake) ⭐ 702 | 🐛 50 | 🌐 Nix | 📅 2026-02-08 - A NixOS-like service configuration framework for Nix flakes.
...
* [treefmt-nix](https://github.com/numtide/treefmt-nix) ⭐ 544 | 🐛 55 | 🌐 Nix | 📅 2026-02-04 - A formatter that allows formatting all your project files with a single command, all via a single `.nix` file.
...
* [haskell.nix](https://github.com/input-output-hk/haskell.nix) ⭐ 621 | 🐛 170 | 🌐 Nix | 📅 2026-02-11 - Alternative Haskell Infrastructure for Nixpkgs.
...
* [kebab](https://github.com/bwkam/kebab) ⭐ 2 | 🐛 0 | 🌐 Nix | 📅 2026-02-10 - Haxe packages for Nix.
...
* [poetry2nix](https://github.com/nix-community/poetry2nix) ⭐ 937 | 🐛 187 | 🌐 Nix | 📅 2026-02-11 - Build Python packages directly from [Poetry's](https://python-poetry.org/) `poetry.lock`. No conversion step needed.
...
* [rust-overlay](https://github.com/oxalica/rust-overlay) ⭐ 1,392 | 🐛 23 | 🌐 Nix | 📅 2026-02-11 - Pure and reproducible nix overlay of binary distributed Rust toolchains.
...
* [fenix](https://github.com/nix-community/fenix) ⭐ 983 | 🐛 37 | 🌐 Nix | 📅 2026-02-10 - Rust toolchains and Rust analyzer nightly for nix.
...
* [nix-cargo-integration](https://github.com/90-008/nix-cargo-integration) ⭐ 215 | 🐛 5 | 🌐 Nix | 📅 2026-02-10 - A library that allows easy and effortless integration for Cargo projects.
...
* [zig2nix](https://github.com/Cloudef/zig2nix) ⭐ 156 | 🐛 4 | 🌐 Zig | 📅 2026-02-11 - Flake for packaging, building and running Zig projects.
...
* [Home Manager](https://github.com/nix-community/home-manager) ⭐ 9,346 | 🐛 894 | 🌐 Nix | 📅 2026-02-11 - Manage your user configuration just like NixOS.
* [nix-darwin](https://github.com/nix-darwin/nix-darwin) ⭐ 5,059 | 🐛 398 | 🌐 Nix | 📅 2026-02-10 - Manage macOS configuration just like on NixOS.
* [NixOS hardware](https://github.com/NixOS/nixos-hardware) ⭐ 2,922 | 🐛 244 | 🌐 Nix | 📅 2026-02-09 - NixOS profiles to optimize settings for different hardware.
* [NixOS-WSL](https://github.com/nix-community/NixOS-WSL) ⭐ 2,733 | 🐛 48 | 🌐 Nix | 📅 2026-02-10 - Modules for running NixOS on the Windows Subsystem for Linux.
* [NixVim](https://github.com/nix-community/nixvim) ⭐ 2,654 | 🐛 180 | 🌐 Nix | 📅 2026-02-10 - A Neovim distribution built with Nix modules and Nixpkgs.
* [Stylix](https://github.com/nix-community/stylix) ⭐ 2,128 | 🐛 243 | 🌐 Nix | 📅 2026-02-08 - System-wide colorscheming and typography for NixOS.
* [impermanence](https://github.com/nix-community/impermanence) ⭐ 1,678 | 🐛 90 | 🌐 Nix | 📅 2026-01-27 - Lets you choose what files and directories you want to keep between reboots.
...
* [nix-mineral](https://github.com/cynicsketch/nix-mineral) ⭐ 440 | 🐛 30 | 🌐 Nix | 📅 2026-02-03 - Conveniently and reasonably harden NixOS.
...
* [base16.nix](https://github.com/SenchoPens/base16.nix) ⭐ 269 | 🐛 3 | 🌐 Nix | 📅 2025-08-21 - Flake way to theme programs in [base16](https://github.com/chriskempson/base16) ⭐ 886 | 🐛 1 | 📅 2023-10-12 colorschemes, mustache template support included.
...
* [NUR](https://github.com/nix-community/NUR/) ⭐ 1,766 | 🐛 46 | 🌐 Python | 📅 2026-02-11 - Nix User Repositories. The mother of all overlays, allowing access to user repositories and installing packages via attributes.
* [System Manager](https://github.com/numtide/system-manager) ⭐ 1,382 | 🐛 49 | 🌐 Rust | 📅 2026-02-09 - A non-NixOS Linux system configuration tool built on Nix.
...
* [nixpkgs-wayland](https://github.com/nix-community/nixpkgs-wayland) ⭐ 591 | 🐛 50 | 🌐 Nix | 📅 2026-02-10 - Bleeding-edge Wayland packages.
...
* [neovim-nightly-overlay](https://github.com/nix-community/neovim-nightly-overlay) ⭐ 403 | 🐛 1 | 🌐 Nix | 📅 2026-02-11 - Daily bumped Neovim nightly package.
* [awesome-nix-hpc](https://github.com/freuk/awesome-nix-hpc) ⭐ 95 | 🐛 0 | 📅 2025-04-22 - High Performance Computing package sets.
* [nixpkgs-firefox-darwin](https://github.com/bandithedoge/nixpkgs-firefox-darwin) ⭐ 73 | 🐛 3 | 🌐 Nix | 📅 2026-02-11 - Automatically updated Firefox binary packages for macOS.

## Distributions

* [nixbsd](https://github.com/nixos-bsd/nixbsd) ⭐ 857 | 🐛 16 | 🌐 Nix | 📅 2026-01-14 - A NixOS fork with a FreeBSD kernel.
* [NixNG](https://github.com/nix-community/NixNG) ⭐ 437 | 🐛 25 | 🌐 Nix | 📅 2026-02-07 - A GNU/Linux distribution similar to NixOS, defining difference is a focus on containers and lightweightness.
